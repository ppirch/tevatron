...
from tevatron.modeling import EncoderOutput, AggretrieverModel
from tevatron.modeling.aggretriever import AggretrieverModelArguments
...
def main():
    parser = HfArgumentParser((AggretrieverModelArguments, DataArguments, TrainingArguments))
